...
) : BasePresenter<OrganizationViewFragment, OrganizationViewPresenter, OrganizationViewViewModel>()
        , OrganizationViewContract.OrganizationViewPresenter<OrganizationViewFragment> {
