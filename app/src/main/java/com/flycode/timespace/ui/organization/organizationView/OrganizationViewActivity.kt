...
class OrganizationViewActivity
    : BaseActivity<OrganizationViewActivity, OrganizationViewPresenter, OrganizationViewViewModel>(),
        OrganizationViewContract.OrganizationViewActivity,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        organizationViewBinding = DataBindingUtil.setContentView(this,R.layout.activity_organization_view)
    ...
    private fun init(){
        intent.let {
            if (it.hasExtra("organization")){
                viewModel.organization = Gson().fromJson(it.getStringExtra("organization"),Organization::class.java)
                presenter.init()
            }else finish()
        }
