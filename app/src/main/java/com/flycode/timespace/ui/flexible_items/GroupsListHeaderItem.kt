...
class GroupsListHeaderItem(
        var id: Int,
        var name: String,
        var entries: Int = 0
) : AbstractExpandableHeaderItem<GroupsListHeaderItem.ViewHolder, ISectionable<*, *>>()
{
    ...
    var listener : GroupsHeaderItemListener? = null
    ...
    interface GroupsHeaderItemListener{
